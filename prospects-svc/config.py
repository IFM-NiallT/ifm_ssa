...
class ProspectsConfig:
    """
    Configuration class for the Prospects service.
   
    This class manages the configuration settings for the Prospects service,
    ...
    # Logging settings
    log_file: str = "prospects_service.log"
    ...
    @classmethod
    def load_config(cls) -> 'ProspectsConfig':
        """
        Load configuration from the config file.
       
        Returns:
            ProspectsConfig: Configuration instance with loaded settings.
